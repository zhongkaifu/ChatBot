        ...
        public static List<string> AddHtmlTags(List<string> lines)
        {
            ...
            foreach (string line in lines)
            {
                ...
                if (line.Contains(Settings.MessageTag))
                {
                    ...
                    newLine = line.Replace(Settings.MessageTag, $"<div class=\"ai-message\"><button class=\"hidden-button-ai\" type=\"button\" title=\"Refresh\" id=\"refreshTurn" + turnIdx.ToString() + "\" onclick=\"RefreshTurn(" + turnIdx.ToString() + ")\" disabled><img src=\"/images/refresh.png\" width=\"10\"></img></button><img src=\"/images/writer.jpg\" width=\"50\"></img>");
                }
                else
                {
                    newLine = line.Replace(Settings.PromptTag, $"<div class=\"user-message\">") + "<img src=\"/images/reader.jpg\" width=\"50\"></img><button class=\"hidden-button-user\" type=\"button\" title=\"Remove\" id=\"removeTurn" + turnIdx.ToString() + "\" onclick=\"RemoveTurn(" + turnIdx.ToString() + ")\" disabled><img src=\"/images/trashbin.png\" width=\"10\"></img></button>";
                }
